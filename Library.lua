    ...
    function window:Tab(Info)
        ...
        tabFrame.MouseEnter:Connect(function()
            if TabSelected ~= tabFrame then
                TweenService:Create(tabFrame, TweenInfo.new(.15), {BackgroundTransparency = .93}):Play()
            end
        end)
        
        tabFrame.MouseLeave:Connect(function()
            if TabSelected ~= tabFrame then
                TweenService:Create(tabFrame, TweenInfo.new(.15), {BackgroundTransparency = .96}):Play()
            end
        end)
        ...
        function tab:Section(Info)
            ...
            function sectiontable:Toggle(Info)
                ...
                function insidetoggle:Set(bool)
                    ...
                    if not Toggled then
                        TweenService:Create(toggleFrame, TweenInfo.new(.15), {BackgroundColor3 = Color3.fromRGB(68, 68, 68)}):Play()
                    elseif Toggled and not EditOpened then
                        TweenService:Create(toggleFrame, TweenInfo.new(.15), {BackgroundColor3 = Color3.fromRGB(48, 207, 106)}):Play()
                    end
