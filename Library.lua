...
function library:Window(Info)
    ...
    -- Title Text with Glow (ไม่มี Logo)
    ...
    function window:Tab(Info)
        ...
        leftContainer.Position = UDim2.new(0, 136, 0, 53)
        leftContainer.Size = UDim2.new(0, 175, 0, 309)
        ...
        rightContainer.Position = UDim2.new(0, 319, 0, 53)
        rightContainer.Size = UDim2.new(0, 175, 0, 309)
