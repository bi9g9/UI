...
function library:Window(Info)
    ...
    hotkeyLabel.Text = "[" .. Info.ToggleKey.Name .. " to toggle]"
    ...
    hotkeyLabel.Size = UDim2.new(1, -200, 1, 0)
    hotkeyLabel.ZIndex = 3
    hotkeyLabel.Parent = topbar
    ...
    closeButton.Position = UDim2.new(0.96, 0, 0.25, 0)
    ...
    settingsButton.TextColor3 = Color3.fromRGB(237, 237, 237)
    settingsButton.BackgroundTransparency = 1
    settingsButton.Position = UDim2.new(0.91, 0, 0.25, 0)
    settingsButton.Size = UDim2.new(0, 17, 0, 17)
    settingsButton.ZIndex = 2
    settingsButton.Parent = topbar
    
    settingsButton.MouseEnter:Connect(function()
        TweenService:Create(settingsButton, TweenInfo.new(.1), {TextColor3 = Color3.fromRGB(100, 200, 255), Rotation = 90}):Play()
    end)
    
    settingsButton.MouseLeave:Connect(function()
        TweenService:Create(settingsButton, TweenInfo.new(.1), {TextColor3 = Color3.fromRGB(217, 217, 217), Rotation = 0}):Play()
    end)
